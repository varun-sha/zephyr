...
import logging
from os.path import join, dirname, relpath, basename, realpath, normpath, exists, abspath
...
class Exporter(object):
    ...
    def make_key(self, src):
        ...
        elif 'zephyr' in path_list:
            key = 'generated'
        elif path_list.count('..') == 3:
            key = 'zephyr'
        else:
            key = path_list[0]

        #print("Zephyr:make_key::" + str(rel_path) + ":" + str(path_list) +":"+ str(key))
        return key
